...
export const App = () => {
  ...
  const [geussCorrect, setGeussCorrect] = useState(true);
  ...
  const answer = async (e) => {
    ...
    setUserAnswer(userA);
    setGeussCorrect((userA.trim().toLocaleLowerCase() === currentScripture.book_name.trim().toLocaleLowerCase()));
    setShowResult(true);
  }
  ...
  return (
    <div className='container text-center m-5'>
      ...
      <div className='row text-center mt-5'>
        ...
        {geussCorrect ? <i className="fas fa-check-circle fa-5x text-success" ></i>:
